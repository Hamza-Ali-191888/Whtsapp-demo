...
public class RecyclerViewAdapterforStatus extends  RecyclerView.Adapter<RecyclerViewAdapterforStatus.ViewHolder> {
    List<Person1> personList;
    Context context;

    public RecyclerViewAdapterforStatus(List<Person1> personList, Context context) {
    ...
    @Override
    public RecyclerViewAdapterforStatus.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
